...
#[tauri::command]
pub fn delete_entry(vault_path: String, target_path: String, db: State<'_, DbState>) -> Result<(), AppError> {
...
#[tauri::command]
pub fn create_folder(vault_path: String, folder_path: String) -> Result<(), AppError> {
    let vault = Path::new(&vault_path);
